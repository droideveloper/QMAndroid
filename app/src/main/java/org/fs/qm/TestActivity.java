...
public class TestActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Variable var3 = new Variable.Builder().name("x3").index(3).coef(4d).bound(ISolver.Bound.LOWER).lhs(0d).rhs(0d).build();

        //MAX z = 10x1 + 6x2 + 4x3
        FnObjective obj = new FnObjective.Builder().name("simplex").type(Objective.MAXIMIZE).vars(Arrays.asList(var1, var2, var3)).build();
        ...
        Constraint con1 = new Constraint.Builder().name("p").index(1).lhs(0d).rhs(100d).bound(ISolver.Bound.UPPER).vars(Arrays.asList(con1Var1, con1Var2, con1Var3)).build();
        ...
        Constraint con2 = new Constraint.Builder().name("q").index(2).lhs(0d).rhs(600d).bound(ISolver.Bound.UPPER).vars(Arrays.asList(con2Var1, con2Var2, con2Var3)).build();
        ...
        Constraint con3 = new Constraint.Builder().name("r").index(3).lhs(0d).rhs(300d).bound(ISolver.Bound.UPPER).vars(Arrays.asList(con3Var1, con3Var2, con3Var3)).build();
